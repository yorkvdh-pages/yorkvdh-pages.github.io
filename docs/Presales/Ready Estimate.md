In the Ready estimate proposal, Arxus deploys all required Azure components for the customer scope, split up in a setup of a Landing Zone and a setup of included use cases. 
